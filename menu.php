		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<li class="active"><a href="home.php">My Cart</a></li>
						<li class="has-dropdown">
							<a href="index.php#services.html">Services</a>
							<ul class="dropdown">
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">One coffee can change many things.</span>
		...
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					...
					<form action="insert.php" method="post"><center><input type="image" src="1.png"><input type="hidden" name="choco" value="cold"></center></form><br>
				</div>
